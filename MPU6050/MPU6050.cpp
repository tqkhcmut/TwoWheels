...
uint8_t MPU6050::getAuxVDDIOLevel() {
    I2Cdev.readBits(devAddr, MPU6050_RA_YG_OFFS_TC, 1<<MPU6050_TC_PWR_MODE_BIT, buffer);
    return buffer[0];
}
...
void MPU6050::setAuxVDDIOLevel(uint8_t level) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_YG_OFFS_TC, 1<<MPU6050_TC_PWR_MODE_BIT, &level);
}
...
uint8_t MPU6050::getRate() {
    I2Cdev.readBytes(devAddr, MPU6050_RA_SMPLRT_DIV, 1, buffer);
    return buffer[0];
}
...
void MPU6050::setRate(uint8_t rate) {
    I2Cdev.writeBytes(devAddr, MPU6050_RA_SMPLRT_DIV, 1, &rate);
}
...
uint8_t MPU6050::getExternalFrameSync() {
	uint8_t bitMask = 1;
	uint8_t i = 0;
	while(i < MPU6050_CFG_EXT_SYNC_SET_LENGTH)
	{
		bitMask |= 1<<(MPU6050_CFG_EXT_SYNC_SET_BIT+i);
		i++;
	}
    I2Cdev.readBits(devAddr, MPU6050_RA_CONFIG, bitMask, buffer);
    return buffer[0];
}
...
void MPU6050::setExternalFrameSync(uint8_t sync) {
    ...
    I2Cdev.writeBits(devAddr, MPU6050_RA_CONFIG, bitMask, &sync);
}
...
uint8_t MPU6050::getDLPFMode() {
	uint8_t bitMask = 1;
	uint8_t i = 0;
	while(i < MPU6050_CFG_DLPF_CFG_LENGTH)
	{
		bitMask |= 1<<(MPU6050_CFG_DLPF_CFG_BIT+i);
		i++;
	}
    I2Cdev.readBits(devAddr, MPU6050_RA_CONFIG, bitMask, buffer);
    return buffer[0];
...
void MPU6050::setDLPFMode(uint8_t mode) {
    ...
    I2Cdev.writeBits(devAddr, MPU6050_RA_CONFIG, bitMask, &mode);
}
...
uint8_t MPU6050::getFullScaleGyroRange() {
	uint8_t bitMask = 1;
	uint8_t i = 0;
	while(i < MPU6050_GCONFIG_FS_SEL_LENGTH)
	{
		bitMask |= 1<<(MPU6050_GCONFIG_FS_SEL_BIT+i);
		i++;
	}
    I2Cdev.readBits(devAddr, MPU6050_RA_GYRO_CONFIG, bitMask, buffer);
    return buffer[0];
}
...
void MPU6050::setFullScaleGyroRange(uint8_t range) {
    ...
    I2Cdev.writeBits(devAddr, MPU6050_RA_GYRO_CONFIG, bitMask, &range);
}
 ...
 */
uint8_t MPU6050::getAccelXSelfTest() {
    I2Cdev.readBits(devAddr, MPU6050_RA_ACCEL_CONFIG, 1<<MPU6050_ACONFIG_XA_ST_BIT, buffer);
    return buffer[0];
}
/** Get self-test enabled setting for accelerometer X axis.
 ...
 * @see MPU6050_RA_ACCEL_CONFIG
 */
void MPU6050::setAccelXSelfTest(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_ACCEL_CONFIG, 1<<MPU6050_ACONFIG_XA_ST_BIT, (uint8_t*)&enabled);
}
/** Get self-test enabled value for accelerometer Y axis.
 * @return Self-test enabled value
 * @see MPU6050_RA_ACCEL_CONFIG
 */
uint8_t MPU6050::getAccelYSelfTest() {
    I2Cdev.readBits(devAddr, MPU6050_RA_ACCEL_CONFIG, 1<<MPU6050_ACONFIG_YA_ST_BIT, buffer);
    return buffer[0];
}
/** Get self-test enabled value for accelerometer Y axis.
 * @param enabled Self-test enabled value
 * @see MPU6050_RA_ACCEL_CONFIG
 */
void MPU6050::setAccelYSelfTest(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_ACCEL_CONFIG, 1<<MPU6050_ACONFIG_YA_ST_BIT, &&enabled);
}
/** Get self-test enabled value for accelerometer Z axis.
 * @return Self-test enabled value
 * @see MPU6050_RA_ACCEL_CONFIG
 */
uint8_t MPU6050::getAccelZSelfTest() {
    I2Cdev.readBits(devAddr, MPU6050_RA_ACCEL_CONFIG, 1<<MPU6050_ACONFIG_ZA_ST_BIT, buffer);
    return buffer[0];
}
 ...
 * @see MPU6050_RA_ACCEL_CONFIG
 */
void MPU6050::setAccelZSelfTest(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_ACCEL_CONFIG, 1<<MPU6050_ACONFIG_ZA_ST_BIT, &&enabled);
}
...
uint8_t MPU6050::getFullScaleAccelRange() {
	uint8_t bitMask = 1;
	uint8_t i = 0;
	while(i < MPU6050_ACONFIG_AFS_SEL_LENGTH)
	{
		bitMask |= 1<<(MPU6050_ACONFIG_AFS_SEL_BIT+i);
		i++;
	}
    I2Cdev.readBits(devAddr, MPU6050_RA_ACCEL_CONFIG, bitMask, buffer);
    return buffer[0];
}
...
void MPU6050::setFullScaleAccelRange(uint8_t range) {
    ...
    I2Cdev.writeBits(devAddr, MPU6050_RA_ACCEL_CONFIG, bitMask, &range);
}
...
uint8_t MPU6050::getDHPFMode() {
	uint8_t bitMask = 1;
	uint8_t i = 0;
	while(i < MPU6050_ACONFIG_ACCEL_HPF_LENGTH)
	{
		bitMask |= 1<<(MPU6050_ACONFIG_ACCEL_HPF_BIT+i);
		i++;
	}
    I2Cdev.readBits(devAddr, MPU6050_RA_ACCEL_CONFIG, bitMask, buffer);
    return buffer[0];
...
void MPU6050::setDHPFMode(uint8_t bandwidth) {
    ...
    I2Cdev.writeBits(devAddr, MPU6050_RA_ACCEL_CONFIG, bitMask, &bandwidth);
}
...
uint8_t MPU6050::getFreefallDetectionThreshold() {
    I2Cdev.readBytes(devAddr, MPU6050_RA_FF_THR, 1, buffer);
    return buffer[0];
}
/** Get free-fall event acceleration threshold.
...
void MPU6050::setFreefallDetectionThreshold(uint8_t threshold) {
    I2Cdev.writeBytes(devAddr, MPU6050_RA_FF_THR, 1, &threshold);
}
...
uint8_t MPU6050::getFreefallDetectionDuration() {
    I2Cdev.readBytes(devAddr, MPU6050_RA_FF_DUR, 1, buffer);
    return buffer[0];
}
/** Get free-fall event duration threshold.
...
void MPU6050::setFreefallDetectionDuration(uint8_t duration) {
    I2Cdev.writeBytes(devAddr, MPU6050_RA_FF_DUR, 1, &duration);
}
...
uint8_t MPU6050::getMotionDetectionThreshold() {
    I2Cdev.readBytes(devAddr, MPU6050_RA_MOT_THR, 1, buffer);
    return buffer[0];
}
...
void MPU6050::setMotionDetectionThreshold(uint8_t threshold) {
    I2Cdev.writeBytes(devAddr, MPU6050_RA_MOT_THR, 1, &threshold);
}
...
uint8_t MPU6050::getMotionDetectionDuration() {
    I2Cdev.readBytes(devAddr, MPU6050_RA_MOT_DUR, 1, buffer);
    return buffer[0];
}
...
void MPU6050::setMotionDetectionDuration(uint8_t duration) {
    I2Cdev.writeBytes(devAddr, MPU6050_RA_MOT_DUR, 1, &duration);
}
...
uint8_t MPU6050::getZeroMotionDetectionThreshold() {
    I2Cdev.readBytes(devAddr, MPU6050_RA_ZRMOT_THR, 1, buffer);
    return buffer[0];
}
...
void MPU6050::setZeroMotionDetectionThreshold(uint8_t threshold) {
    I2Cdev.writeBytes(devAddr, MPU6050_RA_ZRMOT_THR, 1, &threshold);
}
...
uint8_t MPU6050::getZeroMotionDetectionDuration() {
    I2Cdev.readBytes(devAddr, MPU6050_RA_ZRMOT_DUR, 1, buffer);
    return buffer[0];
}
...
void MPU6050::setZeroMotionDetectionDuration(uint8_t duration) {
    I2Cdev.writeBytes(devAddr, MPU6050_RA_ZRMOT_DUR, 1, &duration);
}
 ...
 */
uint8_t MPU6050::getTempFIFOEnabled() {
    I2Cdev.readBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_TEMP_FIFO_EN_BIT, buffer);
    return buffer[0];
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void MPU6050::setTempFIFOEnabled(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_TEMP_FIFO_EN_BIT, &enabled);
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
uint8_t MPU6050::getXGyroFIFOEnabled() {
    I2Cdev.readBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_XG_FIFO_EN_BIT, buffer);
    return buffer[0];
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void MPU6050::setXGyroFIFOEnabled(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_XG_FIFO_EN_BIT, &enabled);
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
uint8_t MPU6050::getYGyroFIFOEnabled() {
    I2Cdev.readBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_YG_FIFO_EN_BIT, buffer);
    return buffer[0];
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void MPU6050::setYGyroFIFOEnabled(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_YG_FIFO_EN_BIT, &enabled);
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
uint8_t MPU6050::getZGyroFIFOEnabled() {
    I2Cdev.readBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_ZG_FIFO_EN_BIT, buffer);
    return buffer[0];
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void MPU6050::setZGyroFIFOEnabled(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_ZG_FIFO_EN_BIT, &enabled);
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
uint8_t MPU6050::getAccelFIFOEnabled() {
    I2Cdev.readBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_ACCEL_FIFO_EN_BIT, buffer);
    return buffer[0];
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void MPU6050::setAccelFIFOEnabled(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_ACCEL_FIFO_EN_BIT, &enabled);
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
uint8_t MPU6050::getSlave2FIFOEnabled() {
    I2Cdev.readBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_SLV2_FIFO_EN_BIT, buffer);
    return buffer[0];
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void MPU6050::setSlave2FIFOEnabled(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_SLV2_FIFO_EN_BIT, &enabled);
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
uint8_t MPU6050::getSlave1FIFOEnabled() {
    I2Cdev.readBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_SLV1_FIFO_EN_BIT, buffer);
    return buffer[0];
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void MPU6050::setSlave1FIFOEnabled(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_SLV1_FIFO_EN_BIT, &enabled);
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
uint8_t MPU6050::getSlave0FIFOEnabled() {
    I2Cdev.readBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_SLV0_FIFO_EN_BIT, buffer);
    return buffer[0];
}
 ...
 * @see MPU6050_RA_FIFO_EN
 */
void MPU6050::setSlave0FIFOEnabled(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_FIFO_EN, 1<<MPU6050_SLV0_FIFO_EN_BIT, &enabled);
}
 ...
 */
uint8_t MPU6050::getMultiMasterEnabled() {
    I2Cdev.readBits(devAddr, MPU6050_RA_I2C_MST_CTRL, 1<<MPU6050_MULT_MST_EN_BIT, buffer);
    return buffer[0];
}
 ...
 * @see MPU6050_RA_I2C_MST_CTRL
 */
void MPU6050::setMultiMasterEnabled(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_I2C_MST_CTRL, 1<<MPU6050_MULT_MST_EN_BIT, &enabled);
}
 ...
 * @see MPU6050_RA_I2C_MST_CTRL
 */
uint8_t MPU6050::getWaitForExternalSensorEnabled() {
    I2Cdev.readBits(devAddr, MPU6050_RA_I2C_MST_CTRL, 1<<MPU6050_WAIT_FOR_ES_BIT, buffer);
    return buffer[0];
}
 ...
 * @see MPU6050_RA_I2C_MST_CTRL
 */
void MPU6050::setWaitForExternalSensorEnabled(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_I2C_MST_CTRL, 1<<MPU6050_WAIT_FOR_ES_BIT, &enabled);
}
 ...
 */
uint8_t MPU6050::getSlave3FIFOEnabled() {
    I2Cdev.readBits(devAddr, MPU6050_RA_I2C_MST_CTRL, 1<<MPU6050_SLV_3_FIFO_EN_BIT, buffer);
    return buffer[0];
}
 ...
 * @see MPU6050_RA_MST_CTRL
 */
void MPU6050::setSlave3FIFOEnabled(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_I2C_MST_CTRL, 1<<MPU6050_SLV_3_FIFO_EN_BIT, &enabled);
}
 ...
 * @see MPU6050_RA_I2C_MST_CTRL
 */
uint8_t MPU6050::getSlaveReadWriteTransitionEnabled() {
    I2Cdev.readBits(devAddr, MPU6050_RA_I2C_MST_CTRL, 1<<MPU6050_I2C_MST_P_NSR_BIT, buffer);
    return buffer[0];
}
 ...
 * @see MPU6050_RA_I2C_MST_CTRL
 */
void MPU6050::setSlaveReadWriteTransitionEnabled(uint8_t enabled) {
    I2Cdev.writeBits(devAddr, MPU6050_RA_I2C_MST_CTRL, 1<<MPU6050_I2C_MST_P_NSR_BIT, &enabled);
}
 ...
 */
uint8_t MPU6050::getSlaveEnabled(uint8_t num) {
    if (num > 3) return 0;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
void MPU6050::setSlaveEnabled(uint8_t num, uint8_t enabled) {
    if (num > 3) return;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
uint8_t MPU6050::getSlaveWordByteSwap(uint8_t num) {
    if (num > 3) return 0;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
void MPU6050::setSlaveWordByteSwap(uint8_t num, uint8_t enabled) {
    if (num > 3) return;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
uint8_t MPU6050::getSlaveWriteMode(uint8_t num) {
    if (num > 3) return 0;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
void MPU6050::setSlaveWriteMode(uint8_t num, uint8_t mode) {
    if (num > 3) return;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
uint8_t MPU6050::getSlaveWordGroupOffset(uint8_t num) {
    if (num > 3) return 0;
 ...
 * @see MPU6050_RA_I2C_SLV0_CTRL
 */
void MPU6050::setSlaveWordGroupOffset(uint8_t num, uint8_t enabled) {
    if (num > 3) return;
 ...
 */
uint8_t MPU6050::getSlave4Enabled() {
 ...
 * @see MPU6050_RA_I2C_SLV4_CTRL
 */
void MPU6050::setSlave4Enabled(uint8_t enabled) {
 ...
 * @see MPU6050_RA_I2C_SLV4_CTRL
 */
uint8_t MPU6050::getSlave4InterruptEnabled() {
 ...
 * @see MPU6050_RA_I2C_SLV4_CTRL
 */
void MPU6050::setSlave4InterruptEnabled(uint8_t enabled) {
 ...
 * @see MPU6050_RA_I2C_SLV4_CTRL
 */
uint8_t MPU6050::getSlave4WriteMode() {
 ...
 * @see MPU6050_RA_I2C_SLV4_CTRL
 */
void MPU6050::setSlave4WriteMode(uint8_t mode) {
 ...
 */
uint8_t MPU6050::getPassthroughStatus() {
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
uint8_t MPU6050::getSlave4IsDone() {
 ...
 * @see MPU6050_RA_I2C_MST_STATUS
 */
uint8_t MPU6050::getLostArbitration() {
 ...
 */
uint8_t MPU6050::getInterruptMode() {
 ...
 */
uint8_t MPU6050::getInterruptDrive() {
 ...
 * @see MPU6050_INTCFG_INT_OPEN_BIT
 */
void MPU6050::setInterruptDrive(uint8_t drive) {
 ...
 */
uint8_t MPU6050::getInterruptLatch() {
 ...
 * @see MPU6050_INTCFG_LATCH_INT_EN_BIT
 */
void MPU6050::setInterruptLatch(uint8_t latch) {
 ...
 */
uint8_t MPU6050::getInterruptLatchClear() {
 ...
 * @see MPU6050_INTCFG_INT_RD_CLEAR_BIT
 */
void MPU6050::setInterruptLatchClear(uint8_t clear) {
 ...
 */
uint8_t MPU6050::getFSyncInterruptLevel() {
 ...
 * @see MPU6050_INTCFG_FSYNC_INT_LEVEL_BIT
 */
void MPU6050::setFSyncInterruptLevel(uint8_t level) {
 ...
 */
uint8_t MPU6050::getFSyncInterruptEnabled() {
 ...
 * @see MPU6050_INTCFG_FSYNC_INT_EN_BIT
 */
void MPU6050::setFSyncInterruptEnabled(uint8_t enabled) {
 ...
 */
uint8_t MPU6050::getI2CBypassEnabled() {
 ...
 * @see MPU6050_INTCFG_I2C_BYPASS_EN_BIT
 */
void MPU6050::setI2CBypassEnabled(uint8_t enabled) {
 ...
 */
uint8_t MPU6050::getClockOutputEnabled() {
 ...
 * @see MPU6050_INTCFG_CLKOUT_EN_BIT
 */
void MPU6050::setClockOutputEnabled(uint8_t enabled) {
 ...
 * @see MPU6050_INTERRUPT_FF_BIT
 **/
uint8_t MPU6050::getIntFreefallEnabled() {
 ...
 * @see MPU6050_INTERRUPT_FF_BIT
 **/
void MPU6050::setIntFreefallEnabled(uint8_t enabled) {
 ...
 **/
uint8_t MPU6050::getIntMotionEnabled() {
 ...
 * @see MPU6050_INTERRUPT_MOT_BIT
 **/
void MPU6050::setIntMotionEnabled(uint8_t enabled) {
 ...
 **/
uint8_t MPU6050::getIntZeroMotionEnabled() {
 ...
 * @see MPU6050_INTERRUPT_ZMOT_BIT
 **/
void MPU6050::setIntZeroMotionEnabled(uint8_t enabled) {
 ...
 **/
uint8_t MPU6050::getIntFIFOBufferOverflowEnabled() {
 ...
 * @see MPU6050_INTERRUPT_FIFO_OFLOW_BIT
 **/
void MPU6050::setIntFIFOBufferOverflowEnabled(uint8_t enabled) {
 ...
 **/
uint8_t MPU6050::getIntI2CMasterEnabled() {
 ...
 * @see MPU6050_INTERRUPT_I2C_MST_INT_BIT
 **/
void MPU6050::setIntI2CMasterEnabled(uint8_t enabled) {
 ...
 * @see MPU6050_INTERRUPT_DATA_RDY_BIT
 */
void MPU6050::setIntDataReadyEnabled(uint8_t enabled) {
 ...
 * @see MPU6050_INTERRUPT_FF_BIT
 */
uint8_t MPU6050::getIntFreefallStatus() {
 ...
 * @see MPU6050_INTERRUPT_MOT_BIT
 */
uint8_t MPU6050::getIntMotionStatus() {
 ...
 * @see MPU6050_INTERRUPT_ZMOT_BIT
 */
uint8_t MPU6050::getIntZeroMotionStatus() {
 ...
 * @see MPU6050_INTERRUPT_FIFO_OFLOW_BIT
 */
uint8_t MPU6050::getIntFIFOBufferOverflowStatus() {
 ...
 * @see MPU6050_INTERRUPT_I2C_MST_INT_BIT
 */
uint8_t MPU6050::getIntI2CMasterStatus() {
 ...
 * @see MPU6050_INTERRUPT_DATA_RDY_BIT
 */
uint8_t MPU6050::getIntDataReadyStatus() {
 ...
 */
uint8_t MPU6050::getXNegMotionDetected() {
 ...
 */
uint8_t MPU6050::getXPosMotionDetected() {
 ...
 */
uint8_t MPU6050::getYNegMotionDetected() {
 ...
 */
uint8_t MPU6050::getYPosMotionDetected() {
 ...
 */
uint8_t MPU6050::getZNegMotionDetected() {
 ...
 */
uint8_t MPU6050::getZPosMotionDetected() {
 ...
 */
uint8_t MPU6050::getZeroMotionDetected() {
 ...
 */
uint8_t MPU6050::getExternalShadowDelayEnabled() {
 ...
 * @see MPU6050_DELAYCTRL_DELAY_ES_SHADOW_BIT
 */
void MPU6050::setExternalShadowDelayEnabled(uint8_t enabled) {
 ...
 */
uint8_t MPU6050::getSlaveDelayEnabled(uint8_t num) {
 ...
 * @see MPU6050_DELAYCTRL_I2C_SLV0_DLY_EN_BIT
 */
void MPU6050::setSlaveDelayEnabled(uint8_t num, uint8_t enabled) {
 ...
 */
uint8_t MPU6050::getFIFOEnabled() {
 ...
 * @see MPU6050_USERCTRL_FIFO_EN_BIT
 */
void MPU6050::setFIFOEnabled(uint8_t enabled) {
 ...
 */
uint8_t MPU6050::getI2CMasterModeEnabled() {
 ...
 * @see MPU6050_USERCTRL_I2C_MST_EN_BIT
 */
void MPU6050::setI2CMasterModeEnabled(uint8_t enabled) {
 ...
 */
void MPU6050::switchSPIEnabled(uint8_t enabled) {
 ...
 */
uint8_t MPU6050::getSleepEnabled() {
 ...
 */
uint8_t MPU6050::getWakeCycleEnabled() {
 ...
 * @see MPU6050_PWR1_CYCLE_BIT
 */
void MPU6050::setWakeCycleEnabled(uint8_t enabled) {
 ...
 */
uint8_t MPU6050::getTempSensorEnabled() {
 ...
 * @see MPU6050_PWR1_TEMP_DIS_BIT
 */
void MPU6050::setTempSensorEnabled(uint8_t enabled) {
 ...
 */
uint8_t MPU6050::getStandbyXAccelEnabled() {
 ...
 * @see MPU6050_PWR2_STBY_XA_BIT
 */
void MPU6050::setStandbyXAccelEnabled(uint8_t enabled) {
 ...
 */
uint8_t MPU6050::getStandbyYAccelEnabled() {
 ...
 * @see MPU6050_PWR2_STBY_YA_BIT
 */
void MPU6050::setStandbyYAccelEnabled(uint8_t enabled) {
 ...
 */
uint8_t MPU6050::getStandbyZAccelEnabled() {
 ...
 * @see MPU6050_PWR2_STBY_ZA_BIT
 */
void MPU6050::setStandbyZAccelEnabled(uint8_t enabled) {
 ...
 */
uint8_t MPU6050::getStandbyXGyroEnabled() {
 ...
 * @see MPU6050_PWR2_STBY_XG_BIT
 */
void MPU6050::setStandbyXGyroEnabled(uint8_t enabled) {
 ...
 */
uint8_t MPU6050::getStandbyYGyroEnabled() {
 ...
 * @see MPU6050_PWR2_STBY_YG_BIT
 */
void MPU6050::setStandbyYGyroEnabled(uint8_t enabled) {
 ...
 */
uint8_t MPU6050::getStandbyZGyroEnabled() {
 ...
 * @see MPU6050_PWR2_STBY_ZG_BIT
 */
void MPU6050::setStandbyZGyroEnabled(uint8_t enabled) {
